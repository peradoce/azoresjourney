...
class Artigo(models.Model):
    ...
    descricao_en = RichTextField(blank=True, null=True)
...
class DetalheIlha(models.Model):
    ...
    historia_en = RichTextField(blank=True, null=True)
...
class Evento(models.Model):
    ...
    cartaz = RichTextField()
    cartaz_en = RichTextField(blank=True, null=True)
    imagem = models.FileField(upload_to='city_images')
    video = models.CharField(max_length=100, blank=True, null=True)

class ComidaRegional(models.Model):
    comida = models.CharField(max_length=60)
    receita = RichTextField()
    receita_en = RichTextField(blank=True, null=True)
